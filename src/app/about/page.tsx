...
export default function AboutPage() {
  ...
  const values = [
    ...
    },
    {
      ...
      title: 'Innovation',
      description: 'We embrace innovation and stay ahead of industry trends and technologies.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-400 mb-6 text-lg">
                Founded in 2019, DigitalAgency began with a simple mission: to help businesses thrive in the digital age. What started as a small team of passionate developers and designers has grown into a full-service digital agency.
              </p>
              <p className="text-gray-400 mb-6 text-lg">
                We&apos;ve worked with startups, established companies, and everything in between. Our approach combines technical expertise with creative vision, ensuring that every project we undertake delivers real results for our clients.
              </p>
              <p className="text-gray-400 text-lg">
                Today, we continue to push the boundaries of what&apos;s possible in web development, design, and digital marketing, always staying ahead of industry trends and technologies.
              </p>
            </div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              The talented individuals who make our vision a reality and deliver exceptional results for our clients.
            </p>
          </div>
