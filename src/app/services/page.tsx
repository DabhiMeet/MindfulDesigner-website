...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      description: 'Strategic marketing campaigns that grow your business and reach your audience.',
      features: [
  ...
  const process = [
    ...
    },
    {
      step: '03',
      title: 'Design',
      description: 'Our creative team designs stunning visuals and user experiences that engage your audience.',
    },
    {
      step: '04',
      title: 'Development',
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              From web development to digital marketing, we provide end-to-end solutions for your digital needs.
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-to-r from-blue-600 to-blue-800">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="bg-white text-blue-600 hover:bg-gray-100 font-semibold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 inline-block">
              Start Your Project
            </Link>
            <Link href="/about" className="border-2 border-white text-white hover:bg-white hover:text-blue-600 font-semibold py-4 px-8 rounded-lg transition-all duration-300">
              Learn More About Us
            </Link>
          </div>
        </div>
